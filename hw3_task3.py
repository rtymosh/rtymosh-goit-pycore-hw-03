...
# Нормалізовані номери телефонів для SMS-розсилки: ['+380671234567',
# '+380952345678', '+380441234567', '+380501234567', '+380501233234',
# '+380503451234', '+380508889900', '+380501112222', '+380501112211']
import re


def normalize_phone(phone_number: str) -> str:
    # delete all characters except digits and '+'
    filtered_numbers = re.sub(r"[^\d+]", "", phone_number)
    if filtered_numbers.startswith("+38"):
        # already has the correct ukrainian code
        formatted_phone_number = filtered_numbers
    else:
        # add the ukrainian code if missing and it is no matter if '+' is present or not
        formatted_phone_number = "+38" + filtered_numbers.lstrip("+")
